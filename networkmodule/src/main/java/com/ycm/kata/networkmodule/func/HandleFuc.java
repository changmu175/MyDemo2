...
package com.ycm.kata.networkmodule.func;
import com.ycm.kata.networkmodule.exception.ApiException;
import com.ycm.kata.networkmodule.exception.ServerException;
...
public class HandleFuc<T> implements Function<ApiResult<T>, T> {
    ...
    public T apply(@NonNull ApiResult<T> tApiResult) throws Exception {
        if (ApiException.isOk(tApiResult)) {
            ...
            throw new ServerException(0,""/*tApiResult.getCode(), tApiResult.getMsg()*/);
        }
    }
}
