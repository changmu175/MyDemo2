...
import com.ycm.kata.mydemo2.test1.UploadResponse;
import com.ycm.kata.networkmodule.NetworkManager;
import com.ycm.kata.networkmodule.callback.CallBackProxy;
import com.ycm.kata.networkmodule.callback.ProgressDialogCallBack;
import com.ycm.kata.networkmodule.callback.SimpleCallBack;
import com.ycm.kata.networkmodule.callback.UIProgressResponseCallBack;
import com.ycm.kata.networkmodule.exception.ApiException;
import com.ycm.kata.networkmodule.model.ApiResult;
import com.ycm.kata.networkmodule.subscriber.IProgressDialog;
import com.ycm.kata.networkmodule.utils.HttpLog;
...
public class UploadActivity extends AppCompatActivity {
    ...
    public void onUploadFile(View view) throws Exception {
        ...
        NetworkManager.post("/v1/user/uploadAvatar")
...
//    }
    ...
    public void onUploadFileMaps(View view) {
        ...
        NetworkManager.post("AppYuFaKu/uploadHeadImg")
    ...
    public void onUploadFileMaps2(View view) {
        ...
        NetworkManager.post("http://106.14.83.28:89/index.php?s=/Home/user/dj_add_care")
                .params("uid", "1")
                .params("title", "冷小菜")
    ...
    public void onUploadOne(View view) {
        String filePath = Environment.getExternalStorageDirectory().getPath() + File.separator + "A1" + File.separator + "2";
        ...
        NetworkManager.post(NetWorkConstants.UPLOAD_FILE)
//                .baseUrl("http://106.15.42.39")
                .params("file", file, file.getName(), mUIProgressResponseCallBack)
                .params("token", "e3a4c0234b4cf055d95a4ea1eb98dca4c2941c2c")
                .execute1(new CallBackProxy<UploadResponse, String>(new ProgressDialogCallBack<String>(mProgressDialog, true, true) {
                    @Override
                    public void onSuccess(String s) {
                        showToast(s);
                    }
                }) {
                }/*new ProgressDialogCallBack<UploadResponse>(mProgressDialog, true, true) {
                    @Override
                    public void onSuccess(UploadResponse s) {
                        showToast(s.filePath);
                    }
